...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'category' | 'book' | 'order'
  ...
  export type OrderWhereInput = {
    ...
    orderedBooks?: JsonNullableListFilter<"Order">
  ...
  export type OrderCreateInput = {
    id?: string
    orderedBooks?: OrderCreateorderedBooksInput | InputJsonValue[]
    status?: $Enums.orderStatus | null
    createdAt?: Date | string
    updatedAt?: Date | string
  ...
  export type OrderUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    orderedBooks?: OrderUpdateorderedBooksInput | InputJsonValue[]
  ...
  export type OrderCreateorderedBooksInput = {
    set: InputJsonValue[]
  }
  ...
  export type OrderUpdateorderedBooksInput = {
    set?: InputJsonValue[]
